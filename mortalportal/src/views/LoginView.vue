                        ...
                        <q-tab-panel name="Login">
                            ...
                            <q-card-section>
                                <q-form class="q-gutter-md">
                                    <q-input rounded outlined color="secondary" clearable v-model="email_login" type="text" label="Email"
                                    ...
                                    <q-input rounded outlined color="secondary" clearable v-model="password_login" type="password" label="Password"
                                    lazy-rules :rules="[val => val && val.length > 0 || 'Enter your password']" @keyup.enter="getUser"/>
                                </q-form>
                            </q-card-section>
                            <q-card-actions class="q-px-md">
                                <q-btn unelevated color="secondary" size="md"
